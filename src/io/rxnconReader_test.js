goog.provide('sb.io.rxnconReaderTest');

goog.require('goog.testing.jsunit');
goog.require('sb.io.RxnconReader');
...
function testRead01() {
    var reader = new sb.io.RxnconReader();
    try {var doc = reader.parseText(_allData['sbml/BIOMD0000000012.xml'].content);}
    catch(err){e=err;}
    assertEquals(e, 'this is not a rxncon text');
    var doc = reader.parseText(_allData['rxncon/SBML_rxncon.xml'].content);
    dumpDocument(doc)
